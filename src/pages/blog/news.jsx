...
const News = () => {
  return (
    <div className="m-auto w-[800px] p-10">
      ...
      <div className="flex flex-col gap-5">
        <img
          ...
          alt=""
          className="w-[800px] h-[462px] rounded-lg my-5"
        />
        <p>
        ...
        <h1>
          <strong>Research Your Destination</strong>
        </h1>
        <p>
        ...
        <h1>
          <strong>Plan Your Itinerary</strong>
        </h1>
        <p>
